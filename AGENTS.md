# AI Agent Guidelines for https://abhishekwali.dev

This guide provides essential information for AI agents working with the https://abhishekwali.dev codebase - a Next.js dev portfolio and component registry website.

## Project Overview

**https://abhishekwali.dev** is a minimal, pixel-perfect dev portfolio and component registry built with modern web technologies. It serves as:

- Personal portfolio for Abhishek Wali (@Abhishekh3007)
